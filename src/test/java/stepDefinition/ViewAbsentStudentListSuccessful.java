...
@Given("It is my course")
public void it_is_my_course() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
...
public void the_list_of_all_the_students_should_appear() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
@Then("I should have the students that are absent with a special mention")
public void i_should_have_the_students_that_are_absent_with_a_special_mention() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
}
